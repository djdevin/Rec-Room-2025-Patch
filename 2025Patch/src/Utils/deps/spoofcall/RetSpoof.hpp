...
namespace detail
{
    ...
    template <std::size_t Argc, typename Enable = void>
    ...
    struct argument_remapper<Argc, std::enable_if_t<(Argc <= 4), void>>
    {
        template<
            typename Ret,
            typename First = void*,
...
) -> Ret
{
    ...
    using mapper = detail::argument_remapper<sizeof...(Args)>;
