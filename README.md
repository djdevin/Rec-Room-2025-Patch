...
- Own Referee Bypass (yes son no more relying off of Pillow's bypass, also has a bypass to debugging and stuff so yeah pretty cool)
- API Redirection
- Better Dump (https://drive.google.com/file/d/1b4O84qDVrOClI7rwj5S6QrNiZoBlUh_i/view?usp=sharing) (had to put in google drive cuz too big)
